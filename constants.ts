...
export const UI_TEXT = {
  ...
  FALLBACK_API_CONFIG: "Konfigurasi API AI Sandaran",
  FALLBACK_CEREBRAS_KEY: "Kunci API Cerebras (Utama)",
  FALLBACK_REQUESTY_KEY: "Kunci API Requesty (Sandaran 1)",
  FALLBACK_OPENAI_KEY: "Kunci API OpenAI (Sandaran 2)",
  FALLBACK_API_DESC: "Kunci yang dimasukkan di sini akan menggantikan kunci lalai aplikasi. Biarkan kosong untuk menggunakan tetapan asal.",
